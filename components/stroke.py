...
class Stroke():
	...
	def render(self, screen):
		textsurface = self.font.render(self.text, True, self.color).convert_alpha()
		...
		osurf.blit(self.font.render(self.text, True, self.ocolor).convert_alpha(), (0, 0))
		...
		screen.blit(surf, (self.pos[0]-surf.get_width()/2, self.pos[1]-surf.get_height()/2))